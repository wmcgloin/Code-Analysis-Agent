...
with gr.Blocks() as app:
    ...
    with gr.Row():
        with gr.Column():
            repo_path = gr.Textbox(label="Repository Path", placeholder="/path/to/repository")
            query = gr.Textbox(label="Query", placeholder="I want a high-level overview of the codebase structure")
    ...
    analyze_btn.click(
        fn=analyze_repo,
        inputs=[repo_path, query],
        outputs=[html_output, explanation]
    )
