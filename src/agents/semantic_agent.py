"""
Semantic Agent for analyzing code repositories and creating semantic relationship graphs.
This agent focuses on detailed relationships between classes, methods, and functions.
"""
...
class SemanticAgent:
    """
    Agent that analyzes code repositories and creates semantic relationship graphs
    showing how classes, methods, and functions correlate to each other.
    """
    
    def __init__(self, model_name="gpt-4o-mini"):
        """Initialize the semantic agent with the specified LLM model."""
    ...
    def create_visualization(self, graph_documents, output_path="semantic_graph.html"):
        ...
        print(f"Semantic graph saved as {output_path}")
